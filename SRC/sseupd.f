...
c         call svout(logfil, ncv, workl(irz), ndigit,
...
c            call scopy(ncv, workl(iq+ncv-1), ldq, workl(iw), 1)
c            call svout(logfil, ncv, workl(ihd), ndigit,
c     &          '_seupd: NCV Ritz values of the final H matrix')
c            call svout(logfil, ncv, workl(iw), ndigit,
...
c         call svout(logfil, nconv, d, ndigit,
c     &          '_seupd: Untransformed converged Ritz values')
c         call svout(logfil, nconv, workl(ihb), ndigit, 
