...
c         call dvout (logfil, ncv, workl(irr), ndigit,
c     &   '_neupd: Real part of Ritz values passed in from _NAUPD.')
c         call dvout (logfil, ncv, workl(iri), ndigit,
...
c            call dvout (logfil, ncv, workl(iheigr), ndigit,
c     &           '_neupd: Real part of the eigenvalues of H')
c            call dvout (logfil, ncv, workl(iheigi), ndigit,
c     &           '_neupd: Imaginary part of the Eigenvalues of H')
c            call dvout (logfil, ncv, workl(ihbds), ndigit,
c     &           '_neupd: Last row of the Schur vector matrix')
c            if (msglvl .gt. 3) then
c               call dmout (logfil       , ncv, ncv   , 
...
c
c            if (msglvl .gt. 2) then
c               call dcopy (ncv, workl(invsub+ncv-1), ldq,
c     &                    workl(ihbds), 1)
c               call dvout (logfil, ncv, workl(ihbds), ndigit,
c     &              '_neupd: Last row of the eigenvector matrix for T')
c               if (msglvl .gt. 3) then
c                  call dmout (logfil, ncv, ncv, workl(invsub), ldq, 
...
c         call dvout (logfil, nconv, dr, ndigit,
c     &   '_neupd: Untransformed real part of the Ritz valuess.')
c         call dvout  (logfil, nconv, di, ndigit,
c     &   '_neupd: Untransformed imag part of the Ritz valuess.')
c         call dvout (logfil, nconv, workl(ihbds), ndigit,
