...
c         call svout (logfil, np, workl(ritzr), ndigit, 
c     &               '_naupd: Real part of the final Ritz values')
c         call svout (logfil, np, workl(ritzi), ndigit, 
c     &               '_naupd: Imaginary part of the final Ritz values')
c         call svout (logfil, np, workl(bounds), ndigit, 
...
c     &                  tmvopx, tmvbx, tnaupd, tnaup2, tnaitr, titref,
c     &                  tgetv0, tneigh, tngets, tnapps, tnconv, trvec
c 1000    format (//,
c     &      5x, '=============================================',/
c     &      5x, '= Nonsymmetric implicit Arnoldi update code =',/
c     &      5x, '= Version Number: ', ' 2.4', 21x, ' =',/
