...
c            call zvout  (logfil, kplusp, ritz, ndigit,
c     &           '_naup2: The eigenvalues of H')
c            call zvout  (logfil, kplusp, bounds, ndigit, 
...
c               call zvout (logfil, kplusp, workl(kplusp**2+1), ndigit,
c     &             '_naup2: Eigenvalues computed by _neigh:')
c               call zvout (logfil, kplusp, workl(kplusp**2+kplusp+1),
c     &                     ndigit,
...
c               call zvout  (logfil, nev, ritz(np+1), ndigit,
c     &              '_naup2: "wanted" Ritz values ')
c               call zvout  (logfil, nev, bounds(np+1), ndigit,
...
c            call zvout  (logfil, np, ritz, ndigit,
c     &                  '_naup2: values of the shifts')
c            if ( ishift .eq. 1 ) 
c     &          call zvout  (logfil, np, bounds, ndigit,
...
c            call zmout  (logfil, nev, nev, h, ldh, ndigit,
