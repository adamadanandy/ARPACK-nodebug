...
c            call zvout (logfil, 1, sigma, ndigit, 
c     &               '_napps: Value of the shift ')
c         end if
c
         istart = 1
   20    continue
...
c                  call zvout (logfil, 1, h(i+1,i), ndigit, 
